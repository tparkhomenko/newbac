#!/usr/bin/env python3
"""
Unify CSV labels from all ISIC datasets into a single format.
"""
...
def unify_labels(diagnosis):
    ...
    label_map = {
        ...
        "atypical melanocytic proliferation": "other", "unknown": "other",
    }
...
def main():
    ...
    if all_dfs:
        ...
        # Save unified CSV
        output_path = os.path.join(output_dir, "unified_labels.csv")
