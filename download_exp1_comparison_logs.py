#!/usr/bin/env python3
"""
Download full training logs with epochs from WandB exp1_comparison project
"""
...
def download_exp1_comparison_logs():
    """Download all training logs from exp1_comparison project"""
    ...
    # Get the project
    project_name = "taisiyaparkhomenko-technische-universit-t-graz/exp1_comparison"
...
"""
        ...
        combined_logs = f"""
================================================================================
                    EXP1 COMPARISON - FULL WANDB TRAINING LOGS
================================================================================
...
"""
        ...
        # Save to file
        output_file = "exp1_comparison_all_logs.txt"
