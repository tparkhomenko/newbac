#!/usr/bin/env python3
"""
Download full training logs with epochs from WandB loss_comparison_weighted_ce_vs_focal project
"""
...
def download_loss_comparison_weighted_ce_vs_focal_logs():
    """Download all training logs from loss_comparison_weighted_ce_vs_focal project"""
    ...
    # Get the project
    project_name = "taisiyaparkhomenko-technische-universit-t-graz/loss_comparison_weighted_ce_vs_focal"
...
"""
        ...
        combined_logs = f"""
================================================================================
                    LOSS COMPARISON WEIGHTED CE VS FOCAL - FULL WANDB TRAINING LOGS
================================================================================
...
"""
        ...
        # Save to file
        output_file = "loss_comparison_weighted_ce_vs_focal_all_logs.txt"
...
if __name__ == "__main__":
    ...
    if not os.path.exists(os.path.expanduser("~/.netrc")):
        ...
        download_loss_comparison_weighted_ce_vs_focal_logs()
