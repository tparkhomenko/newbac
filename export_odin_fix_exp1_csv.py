#!/usr/bin/env python3
"""
Export a CSV for the W&B project odin_fix_exp1 with requested columns.
...
def main() -> None:
    ...
    project = "taisiyaparkhomenko-technische-universit-t-graz/odin_fix_exp1"
    try:
    ...
    want_names = {"exp1_parallel_lmf_no_odin_fix", "exp1_parallel_lmf_with_odin_fix"}
    filtered = [r for r in runs if r.name in want_names]

    out_path = os.path.join("backend", "experiments_summary_odin_fix.csv")
