#!/usr/bin/env python3
"""
Download full training logs with epochs from WandB exp1_tier2_losses project
"""
...
def download_exp1_tier2_losses_logs():
    """Download all training logs from exp1_tier2_losses project"""
    ...
    # Get the project
    project_name = "taisiyaparkhomenko-technische-universit-t-graz/exp1_tier2_losses"
...
"""
        ...
        combined_logs = f"""
================================================================================
                    EXP1 TIER2 LOSSES - FULL WANDB TRAINING LOGS
================================================================================
...
"""
        ...
        # Save to file
        output_file = "exp1_tier2_losses_wandb_logs.txt"
...
if __name__ == "__main__":
    ...
    if not os.path.exists(os.path.expanduser("~/.netrc")):
        ...
        download_exp1_tier2_losses_logs()
