#!/usr/bin/env python3
"""
Download full training logs with epochs from WandB uploaded project
"""
...
def download_uploaded_logs():
    """Download all training logs from uploaded project"""
    ...
    # Get the project
    project_name = "taisiyaparkhomenko-technische-universit-t-graz/uploaded"
...
"""
        ...
        combined_logs = f"""
================================================================================
                    UPLOADED - FULL WANDB TRAINING LOGS
================================================================================
...
"""
        ...
        # Save to file
        output_file = "uploaded_all_logs.txt"
