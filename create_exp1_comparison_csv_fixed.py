#!/usr/bin/env python3
"""
Create CSV file for exp1_comparison models based on WandB logs (FIXED VERSION)
"""
...
def extract_model_info_from_logs():
    ...
    log_file = "exp1_comparison_all_logs.txt"
    ...
    try:
        ...
        for section in run_sections[1:]:  # Skip first empty section
            try:
                ...
                # Extract run name from the first line (format: "1: exp1_multi_8classes")
                if lines:
                    first_line = lines[0]
                    if ":" in first_line:
        ...
        # Write to CSV
        output_file = "exp1_comparison_summary_fixed.csv"
